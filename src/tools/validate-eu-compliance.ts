/**
 * validate_eu_compliance — Check Ghanaian statute's international compliance status.
 */
...
export async function validateEUCompliance(
  ...
  if (rows.length === 0) {
    recommendations.push(
      'No international references found. If this statute implements international law, consider adding references.'
    );
