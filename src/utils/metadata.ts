/**
 * Response metadata for Ghana Law MCP tool responses.
 */
...
export function generateResponseMetadata(
  ...
  return {
    ...
    disclaimer:
      'This data is derived from GhanaLII (ghalii.org) open data. ' +
      'Verify against official Ghana Gazette publications when legal certainty is required.',
    source_authority: 'GhanaLII (African Legal Information Institute)',
  };
}
