...
const SERVER_NAME = 'ghana-law-mcp';
...
const GITHUB_REPO = 'Ansvar-Systems/ghana-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.GHANA_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.GHANA_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
