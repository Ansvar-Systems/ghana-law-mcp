...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Ghanaian legal professional rules.
...
- Ghana Bar Association rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/ghana-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Ghana)

### Ghana Bar Association and Legal Profession Act

Ghanaian lawyers are bound by strict confidentiality rules under the Legal Profession Act 1960 (Act 32) and the Ghana Bar Association Code of Ethics.

#### Lawyer-Client Privilege

- All lawyer-client communications are privileged
...
### Data Protection Act 2012 (Act 843) and Client Data Processing
...
- Cross-border data transfers must meet adequate protection standards
- The **Data Protection Commission** oversees compliance
...
```
Example: "What does the Companies Act say about director duties?"
```
...
```
Example: "What are the penalties for money laundering under Ghanaian law?"
```
...
3. Client matters: Use commercial legal databases (GhanaLII, LexisNexis)

### For Large Firms / Corporate Legal

1. Negotiate DPAs with AI service providers under Act 843 requirements
...
2. Follow Ghanaian government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/ghana-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **GBA Guidance**: Consult Ghana Bar Association ethics guidance
